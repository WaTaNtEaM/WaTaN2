...
WaTaN2 = Config.WaTaN2 or Config.bot_id
TokenBot = Config.TokenBot or Config.token
NameBot = (DevAbs:get(WaTaN2..'Abs:NameBot') or 'ريلاكس')
--     Source WaTaN2     --
...
if Status or AliSudo(msg) or Sudo(msg) then  
return true  
else  
return false  
end  
...
if Status or AliSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or AliConstructor(msg) or SudoBot(msg) or AliSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or Owner(msg) or AliConstructor(msg) or AliSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or Owner(msg) or AliConstructor(msg) or BasicConstructor(msg) or AliSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or Owner(msg) or AliConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or AliSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or Owner(msg) or AliConstructor(msg) or AliConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or AliSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or Owner(msg) or AliConstructor(msg) or AliConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Admin(msg) or AliSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SecondSudo(msg) or SudoBot(msg) or AliConstructor(msg) or AliSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SecondSudo(msg) or SudoBot(msg) or Cleaner(msg) or AliConstructor(msg) or AliSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
send(chat,msg.id_," ♪︙هذا الملف ليس تابع لسورس ريلاكس")
return false 
end      
...
DevAbs:sadd(WaTaN2..'Abs:AbsConstructor:'..IdGps,IdAliConstructors)  
...
--     Source WaTaN2     --
function DevAbs(chat_id, reply_to_message_id, disable_notification, text, disable_web_page_preview, parse_mode)
...
local rio = (WaTaN2..'Abs:Filters:'..msg.chat_id_)
if rio then
...
local UserName = (dp.username_ or "PPPTP")
for gmatch in string.gmatch(dp.first_name_, "[^%s]+") do
dp.first_name_ = gmatch
end
if status == "WrongWay" then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙عذرا عزيزي ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "Reply" then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙العضو ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "ReplyBy" then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙بواسطة ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
else
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙الحساب محذوف قم بالتاكد واعد المحاوله", 1, 'md')
end
end,nil)   
end
--     Source WaTaN2     --
...
--     Source WaTaN2     --
function riomoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevAbs:get(WaTaN2..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source WaTaN2     --
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://relaxali.ml/ReLaXX/ralax.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape(" جار تحميل النتائج يرجى الانتظار .. ")..'&show_alert=true')
https.request('http://relaxali.ml/ReLaXX/ralax.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape(" جار تحميل النتائج يرجى الانتظار .. ")..'&show_alert=true')
https.request('http://relaxali.ml/ReLaXX/ralax.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape(" جار تحميل النتائج يرجى الانتظار .. ")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://relaxali.ml/ReLaXX/ralax.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
if DataText and DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "♪︙الكلمه ↫ "..Ali.." تم حذفها") 
DevAbs:del(WaTaN2..'Abs:Text:GpTexts'..Ali..data.chat_id_)
DevAbs:srem(WaTaN2..'Abs:Manager:GpRedod'..data.chat_id_,Ali)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAbs:smembers(WaTaN2..'Abs:Text:GpTexts'..Ali..data.chat_id_)
...
local Ali = DataText:match('/DelKt:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "♪︙السؤال ↫ "..Ali.." تم حذفه") 
DevAbs:del(WaTaN2..'Abs:Text:KtTexts'..Ali..data.chat_id_)
DevAbs:srem(WaTaN2..'Abs:Sudo:Kt'..data.chat_id_,Ali)
end
if DataText and DataText:match('/EndKt:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/EndKt:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAbs:smembers(WaTaN2..'Abs:Text:KtTexts'..Ali..data.chat_id_)
if DevAbs:get(WaTaN2..'Abs:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "♪︙تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..Ali) 
...
local Ali = DataText:match('/DelAllKt:'..tonumber(data.sender_user_id_)..'(.*)')
if DevAbs:get(WaTaN2..'Abs:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "♪︙تم الغاء عملية حفظ الاسئله للامر ↫ "..Ali) 
DevAbs:del(WaTaN2..'Abs:Add:Kt'..data.sender_user_id_..data.chat_id_)
DevAbs:del(WaTaN2..'Abs:Text:KtTexts'..Ali..data.chat_id_)
...
local Ali = DataText:match('/Song:'..tonumber(data.sender_user_id_)..'(.*)')
Ali = math.random(4,2824); 
local Text ='*♪︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/Song:"..data.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}} 
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. data.chat_id_ .. '&voice=https://t.me/AudiosReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else
end
--     Source WaTaN2     --
if DataText and DataText:match('/mp3:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/mp3:'..tonumber(data.sender_user_id_)..'(.*)')
Ali = math.random(2,1167); 
local Text ='*♪︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/mp3:"..data.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}} 
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendAudio?chat_id=' .. data.chat_id_ .. '&audio=https://t.me/ReLaXMp3/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else
end
--     Source WaTaN2     --
if DataText and DataText:match('/memz:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/memz:'..tonumber(data.sender_user_id_)..'(.*)')
Ali = math.random(2,1201); 
local Text ='*♪︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/memz:"..data.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}} 
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. data.chat_id_ .. '&voice=https://t.me/MemzReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else
end
--     Source WaTaN2     --
if DataText and DataText:match('/gif:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/gif:'..tonumber(data.sender_user_id_)..'(.*)')
Ali = math.random(2,1075); 
local Text ='*♪︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/gif:"..data.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}} 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. data.chat_id_ .. '&animation=https://t.me/GifReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
if DataText and DataText:match('/photo:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/photo:'..tonumber(data.sender_user_id_)..'(.*)')
Ali = math.random(4,1171); 
local Text ='*♪︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/photo:"..data.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}} 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. data.chat_id_ .. '&photo=https://t.me/PhotosReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
if DataText and DataText:match('/anime:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/anime:'..tonumber(data.sender_user_id_)..'(.*)')
Ali = math.random(3,1002); 
local Text ='*♪︙تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/anime:"..data.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}} 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. data.chat_id_ .. '&photo=https://t.me/AnimeReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
if DataText and DataText:match(tonumber(data.sender_user_id_)..':SetMem:(.*)') then
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetMem:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
DevAbs:sadd(WaTaN2..'Abs:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'♪︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'PPPTP')..')\n♪︙تم رفعه في قائمة المميزين')
end,nil)
elseif DataText and DataText:match(tonumber(data.sender_user_id_)..':SetCleaner:(.*)') then
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetCleaner:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetAdmin:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetManager:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetConstructor:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetBasicConstructor:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetOwner:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetSudoBot:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetSecondSudo:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
DevAbs:sadd(WaTaN2..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'♪︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'PPPTP')..')\n♪︙تم رفعه في قائمة المطورين الثانويين')
end,nil)
elseif DataText and DataText:match(tonumber(data.sender_user_id_)..':SetAliSudo:(.*)') then
local AliId = DataText:match(tonumber(data.sender_user_id_)..':SetAliSudo:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemMem:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemCleaner:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemAdmin:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemManager:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemConstructor:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemBasicConstructor:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemOwner:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemSudoBot:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemSecondSudo:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
DevAbs:srem(WaTaN2..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'♪︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'PPPTP')..')\n♪︙تم تنزيله في قائمة المطورين الثانويين')
end,nil)
elseif DataText and DataText:match(tonumber(data.sender_user_id_)..':RemAliSudo:(.*)') then
local AliId = DataText:match(tonumber(data.sender_user_id_)..':RemAliSudo:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':Ban:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
if dp.id_ then
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':UnBan:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':Mute:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
if dp.id_ then
if RankChecking(dp.id_, data.chat_id_) then
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':UnMute:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':UnAll:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':Tkeed:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
if dp.id_ then
if RankChecking(dp.id_, data.chat_id_) then
...
local AliId = DataText:match(tonumber(data.sender_user_id_)..':UnTkeed:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = AliId},function(arg,dp) 
...
local Ali = DataText:match(tonumber(data.sender_user_id_)..':SetList:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = Ali},function(arg,dp) 
if dp.first_name_ == false then
DevAbs(data.chat_id_, data.id_, 1, "♪︙الحساب محذوف", 1, "md")
return false  
end
local Text ='♪︙قم باستعمال الازرار لرفع العضو ↫ ⤈\n♪︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'PPPTP')..')'
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=data.sender_user_id_..":SetMem:"..Ali},{text=" رفع ادمن ",callback_data=data.sender_user_id_..":SetAdmin:"..Ali}},{{text=" رفع منشئ ",callback_data=data.sender_user_id_..":SetConstructor:"..Ali},{text=" رفع مدير ",callback_data=data.sender_user_id_..":SetManager:"..Ali}},{{text=" رفع منظف ",callback_data=data.sender_user_id_..":SetCleaner:"..Ali},{text=" رفع منشئ اساسي ",callback_data=data.sender_user_id_..":SetBasicConstructor:"..Ali}},{{text=" رفع مالك ",callback_data=data.sender_user_id_..":SetOwner:"..Ali},{text=" رفع مطور ",callback_data=data.sender_user_id_..":SetSudoBot:"..Ali}},{{text=" رفع مطور ثانوي ",callback_data=data.sender_user_id_..":SetSecondSudo:"..Ali},{text=" رفع مطور اساسي ",callback_data=data.sender_user_id_..":SetAliSudo:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif AliSudo(data) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=data.sender_user_id_..":SetMem:"..Ali},{text=" رفع ادمن ",callback_data=data.sender_user_id_..":SetAdmin:"..Ali}},{{text=" رفع منشئ ",callback_data=data.sender_user_id_..":SetConstructor:"..Ali},{text=" رفع مدير ",callback_data=data.sender_user_id_..":SetManager:"..Ali}},{{text=" رفع منظف ",callback_data=data.sender_user_id_..":SetCleaner:"..Ali},{text=" رفع منشئ اساسي ",callback_data=data.sender_user_id_..":SetBasicConstructor:"..Ali}},{{text=" رفع مالك ",callback_data=data.sender_user_id_..":SetOwner:"..Ali},{text=" رفع مطور ",callback_data=data.sender_user_id_..":SetSudoBot:"..Ali}},{{text=" رفع مطور ثانوي ",callback_data=data.sender_user_id_..":SetSecondSudo:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=data.sender_user_id_..":SetMem:"..Ali},{text=" رفع ادمن ",callback_data=data.sender_user_id_..":SetAdmin:"..Ali}},{{text=" رفع منشئ ",callback_data=data.sender_user_id_..":SetConstructor:"..Ali},{text=" رفع مدير ",callback_data=data.sender_user_id_..":SetManager:"..Ali}},{{text=" رفع منظف ",callback_data=data.sender_user_id_..":SetCleaner:"..Ali},{text=" رفع منشئ اساسي ",callback_data=data.sender_user_id_..":SetBasicConstructor:"..Ali}},{{text=" رفع مالك ",callback_data=data.sender_user_id_..":SetOwner:"..Ali},{text=" رفع مطور ",callback_data=data.sender_user_id_..":SetSudoBot:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=data.sender_user_id_..":SetMem:"..Ali},{text=" رفع ادمن ",callback_data=data.sender_user_id_..":SetAdmin:"..Ali}},{{text=" رفع منشئ ",callback_data=data.sender_user_id_..":SetConstructor:"..Ali},{text=" رفع مدير ",callback_data=data.sender_user_id_..":SetManager:"..Ali}},{{text=" رفع منظف ",callback_data=data.sender_user_id_..":SetCleaner:"..Ali},{text=" رفع منشئ اساسي ",callback_data=data.sender_user_id_..":SetBasicConstructor:"..Ali}},{{text=" رفع مالك ",callback_data=data.sender_user_id_..":SetOwner:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif AliConstructor(data) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=data.sender_user_id_..":SetMem:"..Ali},{text=" رفع ادمن ",callback_data=data.sender_user_id_..":SetAdmin:"..Ali}},{{text=" رفع منشئ ",callback_data=data.sender_user_id_..":SetConstructor:"..Ali},{text=" رفع مدير ",callback_data=data.sender_user_id_..":SetManager:"..Ali}},{{text=" رفع منظف ",callback_data=data.sender_user_id_..":SetCleaner:"..Ali},{text=" رفع منشئ اساسي ",callback_data=data.sender_user_id_..":SetBasicConstructor:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=data.sender_user_id_..":SetMem:"..Ali},{text=" رفع ادمن ",callback_data=data.sender_user_id_..":SetAdmin:"..Ali}},{{text=" رفع منشئ ",callback_data=data.sender_user_id_..":SetConstructor:"..Ali},{text=" رفع مدير ",callback_data=data.sender_user_id_..":SetManager:"..Ali}},{{text=" رفع منظف ",callback_data=data.sender_user_id_..":SetCleaner:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=data.sender_user_id_..":SetMem:"..Ali},{text=" رفع ادمن ",callback_data=data.sender_user_id_..":SetAdmin:"..Ali}},{{text=" رفع منظف ",callback_data=data.sender_user_id_..":SetCleaner:"..Ali},{text=" رفع مدير ",callback_data=data.sender_user_id_..":SetManager:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=data.sender_user_id_..":SetMem:"..Ali},{text=" رفع ادمن ",callback_data=data.sender_user_id_..":SetAdmin:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=data.sender_user_id_..":SetMem:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
end
...
local Ali = DataText:match(tonumber(data.sender_user_id_)..':RemList:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = Ali},function(arg,dp) 
if dp.first_name_ == false then
DevAbs(data.chat_id_, data.id_, 1, "♪︙الحساب محذوف", 1, "md")
return false  
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=data.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=data.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=data.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=data.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=data.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل منشئ  اساسي ",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Ali}},{{text=" تنزيل مالك ",callback_data=data.sender_user_id_..":RemOwner:"..Ali},{text=" تنزيل مطور ",callback_data=data.sender_user_id_..":RemSudoBot:"..Ali}},{{text=" تنزيل مطور ثانوي ",callback_data=data.sender_user_id_..":RemSecondSudo:"..Ali},{text=" تنزيل مطور اساسي ",callback_data=data.sender_user_id_..":RemAliSudo:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif AliSudo(data) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=data.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=data.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=data.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=data.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=data.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل منشئ  اساسي ",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Ali}},{{text=" تنزيل مالك ",callback_data=data.sender_user_id_..":RemOwner:"..Ali},{text=" تنزيل مطور ",callback_data=data.sender_user_id_..":RemSudoBot:"..Ali}},{{text=" تنزيل مطور ثانوي ",callback_data=data.sender_user_id_..":RemSecondSudo:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=data.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=data.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=data.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=data.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=data.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل منشئ  اساسي ",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Ali}},{{text=" تنزيل مالك ",callback_data=data.sender_user_id_..":RemOwner:"..Ali},{text=" تنزيل مطور ",callback_data=data.sender_user_id_..":RemSudoBot:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=data.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=data.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=data.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=data.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=data.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل منشئ  اساسي ",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Ali}},{{text=" تنزيل مالك ",callback_data=data.sender_user_id_..":RemOwner:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=data.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=data.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=data.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=data.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=data.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل منشئ  اساسي ",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=data.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=data.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=data.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=data.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=data.sender_user_id_..":RemCleaner:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=data.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=data.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منظف ",callback_data=data.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل مدير ",callback_data=data.sender_user_id_..":RemManager:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=data.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=data.sender_user_id_..":RemAdmin:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=data.sender_user_id_..":RemMem:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
local Ali = DataText:match('/DelList:(.*)')
...
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
♪︙[Source Channel](https://t.me/PPPTP)
]] 
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text=" مسح الاساسيين ",callback_data="/DelAliSudo:"..data.sender_user_id_},{text=" مسح الثانويين ",callback_data="/DelSecondSudo:"..data.sender_user_id_}},{{text=" مسح المطورين ",callback_data="/DelSudoBot:"..data.sender_user_id_},{text=" مسح المالكين ",callback_data="/DelOwner:"..data.sender_user_id_}},{{text=" مسح المنشئين الاساسيين ",callback_data="/DelBasicConstructor:"..data.sender_user_id_},{text=" مسح المنشئين ",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text=" مسح المدراء ",callback_data="/DelManagers:"..data.sender_user_id_},{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif AliSudo(data) then
...
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text=" مسح المنشئين ",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text=" مسح المدراء ",callback_data="/DelManagers:"..data.sender_user_id_},{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text=" مسح المدراء ",callback_data="/DelManagers:"..data.sender_user_id_},{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text=" مسح المميزين ",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if Sudo(data) then
if DataText and DataText:match('/DelAliSudo:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/DelAliSudo:'..tonumber(data.sender_user_id_)..'(.*)')
...
if AliSudo(data) then
if DataText and DataText:match('/DelSecondSudo:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/DelSecondSudo:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelSudoBot:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelOwner:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelBasicConstructor:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelConstructor:'..tonumber(data.sender_user_id_)..'(.*)')
DevAbs:del(WaTaN2..'Abs:Constructor:'..data.chat_id_)
Text = "*♪︙تم حذف المنشئين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if Constructor(data) then
if DataText and DataText:match('/DelManager:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/DelManager:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelAdmins:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelVipMem:'..tonumber(data.sender_user_id_)..'(.*)')
...
if AliConstructor(data) then
if DataText and DataText:match('/DelCleanr:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/DelCleanr:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelMute:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelKeed:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelBan:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelListAll:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/ChangeRed:'..tonumber(data.sender_user_id_)..'(.*)')
DevAbs:set(WaTaN2..'Abs:Add:GpRed'..data.sender_user_id_..data.chat_id_,'SetGpRed')
EditMsg(Chat_Id2, Msg_Id2, "♪︙حسنا ارسل الكلمه الان") 
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = DevAbs:get(WaTaN2..'Abs:Add:GpRed'..data.sender_user_id_..data.chat_id_)
if SetGpRed =='SetGpRed' then
if text == "الغاء" then 
DevAbs(data.chat_id_, data.id_, 1, "♪︙تم الغاء الامر" ,  1, "md")
DevAbs:del(WaTaN2..'Abs:Add:GpRed'..data.sender_user_id_..data.chat_id_)
return false
end
Text = "♪︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n♪︙يمكنك اضافة الى النص ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n♪︙للخروج ارسل ↫ ( الغاء )\n ✓"
DevAbs:set(WaTaN2..'Abs:Add:GpRed'..data.sender_user_id_..data.chat_id_,'SaveGpRed')
DevAbs:set(WaTaN2..'Abs:Add:GpText'..data.sender_user_id_..data.chat_id_,text)
DevAbs:sadd(WaTaN2..'Abs:Manager:GpRed'..data.chat_id_,text)
DevAbs:set(WaTaN2..'DelManagerRep'..data.chat_id_,text)
keyboard = {} 
keyboard.inline_keyboard = {{{text=" تغير الرد ",callback_data="/ChangeRed:"..data.sender_user_id_}},{{text=" الغاء ",callback_data="/CancelRed:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source WaTaN2     --
if DataText and DataText:match('/ChangeAllRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/ChangeAllRed:'..tonumber(data.sender_user_id_)..'(.*)')
if not Bot(data) and DevAbs:get(WaTaN2..'Abs:Lock:Rd'..data.chat_id_) then 
...
DevAbs:set(WaTaN2.."Abs:Add:AllRed"..data.sender_user_id_,'SetAllRed')
EditMsg(Chat_Id2, Msg_Id2, "♪︙حسنا ارسل الكلمه الان") 
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevAbs:get(WaTaN2.."Abs:Add:AllRed"..data.sender_user_id_)
...
Text = "♪︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n♪︙يمكنك اضافة الى النص ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ معرف المستخدم\n `#datas` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n♪︙للخروج ارسل ↫ ( الغاء )\n ✓"
DevAbs:set(WaTaN2.."Abs:Add:AllRed"..data.sender_user_id_,'SaveAllRed')
DevAbs:set(WaTaN2.."Abs:Add:AllText"..data.sender_user_id_, text)
DevAbs:sadd(WaTaN2.."Abs:Sudo:AllRed",text)
DevAbs:set(WaTaN2.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text=" تغير الرد ",callback_data="/ChangeAllRed:"..data.sender_user_id_}},{{text=" الغاء ",callback_data="/CancelAllRed:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source WaTaN2     --
if DataText and DataText:match('/DelCmd:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/DelCmd:'..tonumber(data.sender_user_id_)..'(.*)')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" رجوع ",callback_data="/CmdList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText and DataText:match('/SetCmd:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/SetCmd:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/On:'..tonumber(data.sender_user_id_)..'(.*)')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" ترتيب الاوامر ",callback_data="/SetCmdGp:"..data.sender_user_id_},{text=" رفع الادمنيه ",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text=" غادر ",callback_data="/LeaveBot:"..data.sender_user_id_},{text=" تعطيل ",callback_data="/Stop:"..data.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevAbs:set(WaTaN2..'Abs:SudosGp'..data.sender_user_id_..data.chat_id_,"rio")
end
...
local Ali = DataText:match('/Stop:'..tonumber(data.sender_user_id_)..'(.*)')
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,dp) 
...
keyboard = {}
keyboard.inline_keyboard = {{{text=" غادر ",callback_data="/LeaveBot:"..data.sender_user_id_},{text=" تفعيل ",callback_data="/On:"..data.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Ali = DataText:match('/SetCmdGp:'..tonumber(data.sender_user_id_)..'(.*)')
DevAbs:set(WaTaN2.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
DevAbs:sadd(WaTaN2.."List:Cmd:Group:New"..data.chat_id_,"ا")
DevAbs:set(WaTaN2.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
DevAbs:sadd(WaTaN2.."List:Cmd:Group:New"..data.chat_id_,"م")
...
Text = "♪︙تم ترتيب الاوامر بالشكل التالي ~\n♪︙ ايدي - ا .\n♪︙ رفع مميز - م .\n♪︙رفع ادمن - اد .\n♪︙ رفع مدير - مد . \n♪︙ رفع منشى - من . \n♪︙ رفع منشئ الاساسي - اس  .\n♪︙ رفع مطور - مط .\n♪︙رفع مطور ثانوي - ثانوي .\n♪︙ تنزيل الكل - تك .\n♪︙ تعطيل الايدي بالصوره - تعط .\n♪︙ تفعيل الايدي بالصوره - تفع .\n♪︙ الرابط - ر .\n♪︙ ردود المدير - رر .\n♪︙ مسح المكتومين - ،، .\n♪︙ اضف رد - رد .\n♪︙ مسح سحكاتي - سح .\n♪︙ مسح رسائلي - رس .\n♪︙ غنيلي - غ .\n♪︙مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text=" رجوع ",callback_data="/Reload:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source WaTaN2     --
if DataText and DataText:match('/Reload:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/Reload:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UploadAdmin:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/CancelAllRed:'..tonumber(data.sender_user_id_)..'(.*)')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if DataText and DataText:match('/CancelRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/CancelRed:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/CmdList:(.*)')
if tonumber(Ali) == tonumber(data.sender_user_id_) then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" ترتيب الاوامر ",callback_data="/SetCmd:"..data.sender_user_id_},{text=" مسح الاوامر المضافه ",callback_data="/DelCmd:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
...
local Ali = DataText:match('/DelHome:(.*)')
if tonumber(Ali) == tonumber(data.sender_user_id_) then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" مسح رسائلي ",callback_data="/DelMsg:"..data.sender_user_id_},{text=" مسح سحكاتي ",callback_data="/DelEdit:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
...
local Ali = DataText:match('/DelEdit:'..tonumber(data.sender_user_id_)..'(.*)')
DevAbs:del(WaTaN2..'Abs:EditMsg'..data.chat_id_..':'..data.sender_user_id_)
Text = "*♪︙تم حذف جميع تعديلاتك بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text=" رجوع ",callback_data="/DelHome:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source WaTaN2     --
if DataText and DataText:match('/DelMsg:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/DelMsg:'..tonumber(data.sender_user_id_)..'(.*)')
DevAbs:del(WaTaN2..'Abs:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
...
local Ali = DataText:match('/FilterList:(.*)')
if tonumber(Ali) == tonumber(data.sender_user_id_) then
...
local Ali = DataText:match('/DelPhoto:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelTextfilter:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/DelAllFilter:'..tonumber(data.sender_user_id_)..'(.*)')
DevAbs:del(WaTaN2..'Abs:Filters:'..data.chat_id_)
DevAbs:del(WaTaN2.."Abs:FilterAnimation"..data.chat_id_)
DevAbs:del(WaTaN2.."Abs:FilterPhoto"..data.chat_id_)
DevAbs:del(WaTaN2.."Abs:FilterSteckr"..data.chat_id_)
...
local Ali = DataText:match('/locklist:(.*)')
if tonumber(Ali) == tonumber(data.sender_user_id_) then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" قفل البوتات بالطرد ",callback_data="/lockBotKick:"..data.sender_user_id_},{text=" قفل البوتات بالتقيد ",callback_data="/lockBotKed:"..data.sender_user_id_}},{{text=" قفل البوتات بالكتم ",callback_data="/lockBotDel:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" رجوع ",callback_data="/locklist:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source WaTaN2     --
if DataText and DataText:match('/LockSpamList:(.*)') then
local Ali = DataText:match('/LockSpamList:(.*)')
if tonumber(Ali) == tonumber(data.sender_user_id_) then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" قفل التكرار بالطرد ",callback_data="/lockSpamKick:"..data.sender_user_id_},{text=" قفل التكرار بالتقيد ",callback_data="/lockSpamKed:"..data.sender_user_id_}},{{text=" قفل التكرار بالحذف ",callback_data="/lockSpamDel:"..data.sender_user_id_},{text=" قفل التكرار بالكتم ",callback_data="/lockSpamMute:"..data.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" رجوع ",callback_data="/locklist:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source WaTaN2     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" رجوع ",callback_data="/locklist:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" رجوع ",callback_data="/LockBotList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" رجوع ",callback_data="/LockSpamList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Ali = DataText:match('/UpdateSource:'..tonumber(data.sender_user_id_)..'(.*)')
os.execute('rm -rf WaTaN2.lua') 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" رجوع ",callback_data="/SourceList:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText and DataText:match('/UpdateFile:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/UpdateFile:'..tonumber(data.sender_user_id_)..'(.*)')
dofile('WaTaN2.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
local Ali = DataText:match('/MediaHome:(.*)')
if tonumber(Ali) == tonumber(data.sender_user_id_) then
...
local Ali = DataText:match('/DelMedia:'..tonumber(data.sender_user_id_)..'(.*)')
...
if Del ~= 0 then
DevAbs(data.chat_id_, data.id_, 1, "♪︙تم حذف "..Del.." من الميديا", 1, 'md') 
DevAbs:del(WaTaN2.."Abs:cleaner"..data.chat_id_)
else
Text = "*♪︙لا توجد ميديا هنا*"
keyboard = {} 
keyboard.inline_keyboard = {{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" رجوع ",callback_data="/MediaHome:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText and DataText:match('/DelMusic:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/DelMusic:'..tonumber(data.sender_user_id_)..'(.*)')
...
if Del ~= 0 then
DevAbs(data.chat_id_, data.id_, 1, "♪︙تم حذف "..Del.." من الاغاني", 1, 'md') 
...
local Ali = DataText:match('/DelMsgEdit:'..tonumber(data.sender_user_id_)..'(.*)')
Ali_Del = {[0]= data.id_}
...
tdcli_function({ID = "GetMessages",chat_id_ = data.chat_id_,message_ids_ = Ali_Del},function(arg,data)
new = 0
Ali_Del2 = {}
...
DeleteMessage(data.chat_id_,Ali_Del2)
end,nil)  
...
local Ali = DataText:match('/LeaveBot:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/NoLeaveBot:(.*)')
if tonumber(Ali) == tonumber(data.sender_user_id_) then
...
local Ali = DataText:match('/Linkinline:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LinkText:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/lockorder:(.*)')
if tonumber(Ali) == tonumber(data.sender_user_id_) then
...
local Ali = DataText:match('/LockIdPhoto:'..tonumber(data.sender_user_id_)..'(.*)')
DevAbs:set(WaTaN2..'Abs:Lock:Id:Photo'..data.chat_id_,true)
Text = "*♪︙تم تعطيل الايدي بالصوره*"
keyboard = {} 
keyboard.inline_keyboard = {{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..data.sender_user_id_},{text=" رجوع ",callback_data="/lockorder:"..data.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText and DataText:match('/unLockIdPhoto:'..tonumber(data.sender_user_id_)..'(.*)') then
local Ali = DataText:match('/unLockIdPhoto:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockId:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/unLockId:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockGpLinks:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/unLockGpLinks:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockGpLinksinline:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UnLockGpLinksinline:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockWelcome:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UnLockWelcome:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockAllRed:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UnLockAllRed:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UnLockGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockDelMe:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UnLockDelMe:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockKickMe:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UnLockKickMe:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockKickBan:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UnLockKickBan:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockProSet:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UnLocProSet:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/LockGames:'..tonumber(data.sender_user_id_)..'(.*)')
...
local Ali = DataText:match('/UnLockGames:'..tonumber(data.sender_user_id_)..'(.*)')
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حذف الامر من المجموعه", 1, 'html')  
else
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لايوجد امر بهذا الاسم", 1, 'html')
end
DevAbs:del(WaTaN2.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevAbs:get(WaTaN2..'Abs:NameBot') or "ريلاكس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(WaTaN2..'Abs:NameBot') or "ريلاكس")..' ','')
end
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل الامر الجديد", 1, 'html')
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الامر", 1, 'html')
...
local inline = {{{text=" مسح الاوامر المضافه ",callback_data="/DelCmd:"..msg.sender_user_id_},{text=" ترتيب الاوامر ",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حذف الاوامر المضافه في المجموعه", 1, 'html')
end
if text == "حذف الاوامر المضافه" and ChCheck(msg) or text == "حذف الاوامر" and ChCheck(msg) or text == "مسح الاوامر المضافه" and ChCheck(msg) then
local List = DevAbs:smembers(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل الامر القديم", 1, 'html')
return false
end
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل الامر الذي قمت باضافته يدويا", 1, 'html')
return false
end
end
--     Source WaTaN2     --
...
if #List == 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لاتوجد صلاحيات مضافه", 1, 'html')
return false
end
...
DevAbs(msg.chat_id_, msg.id_, 1, t, 1, 'html')
end
if Admin(msg) then
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حذف الصلاحيات المضافه", 1, 'html')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n♪︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevAbs:del(WaTaN2.."Comd:New:rt:Abs:"..ComdNew..msg.chat_id_)
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حذف الصلاحيه", 1, 'html')
end
if DevAbs:get(WaTaN2.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ♪$") then 
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء الامر", 1, 'html')
DevAbs:del(WaTaN2.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
if not Constructor(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تستطيع اضافة صلاحية ( عضو • مميز  • ادمن )\n♪︙ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "ادمن" then
if not Manager(msg) then 
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تستطيع اضافة صلاحية ( عضو • مميز )\n♪︙ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "مميز" then
if not Admin(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تستطيع اضافة صلاحية ( عضو )\n♪︙ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم اضافة الصلاحيه", 1, 'html')
DevAbs:del(WaTaN2.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
end
...
if DevAbs:sismember(WaTaN2.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevAbs:get(WaTaN2.."Comd:New:rt:Abs:"..DEV_RIO..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'PPPTP')..')'..' ❩\n♪︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevAbs:set(WaTaN2.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
...
if result.id_ then
local mrrio = DevAbs:get(WaTaN2.."Comd:New:rt:Abs:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'PPPTP')..')'..' ❩\n♪︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*المعرف غير صحيح*", 1, 'md')
end
end
...
if text =='↫ الاوامر الخدميه ♪' or text =='/play' or text =='↫  رجوع  ♪' or text =='اوامر الخدميه' then
...
local Sudo_Welcome ='♪︙اهلا بك مجددا عزيزي \n♪︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس ريلاكس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ الابراج ♪','↫ حساب العمر ♪'},{'↫ الزخرفه ♪','↫ معاني الاسماء ♪'},{'↫  معرفي ♪','↫  اسمي ♪','↫ ايديي ♪'},{'↫  نبذتي ♪','↫ نبذا ♪'},{'↫  رجوع  ♪'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
...
local inline = {{{text=" ♪ المطور . ",url="t.me/"..(dp.username_ or "PPPTP")}},{{text=" ♪ السورس . ",url="https://t.me/PPPTP"},{text=" ♪ لتنصيب بوت . ",url="https://t.me/AAAPA"}},{{text=" ♪ اضفني في مجموعتك . ",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
...
DevAbs(msg.sender_user_id_, msg.id_, 1, '♪︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "PPPTP")..')', 1, 'md') 
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙العضو قام بحظر البوت لا تستطيع ارسال الرسائل له', 1, 'md')
return false  
end 
if text then
DevAbs(id_user, 0, 1, text, 1, "md")  
...
if text =='الغاء' then   
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevAbs:del(WaTaN2..'Abs:Start:Bots'..msg.sender_user_id_) 
return false
end
DevAbs:set(WaTaN2.."Abs:Start:Bot",text)  
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ كليشة الستارت', 1, 'md')
DevAbs:del(WaTaN2..'Abs:Start:Bots'..msg.sender_user_id_) 
return false
end
if SecondSudo(msg) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙ارسل لي كليشة الستارت الان', 1, 'md')
return false
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حذف كليشة الستارت بنجاح', 1, 'md')
end
...
DevAbs(msg.chat_id_, msg.id_, 1, Start_Source, 1, 'md')
return false
end
if text =='تفعيل التواصل' and ChCheck(msg) or text =='↫ تفعيل التواصل ♪' and ChCheck(msg) then   
local WaTaNTeaM ='♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, WaTaNTeaM, 14, string.len(msg.sender_user_id_))
...
DevAbs(msg.chat_id_,msg.id_, 1, "♪︙تم تفعيل جلب نسخة الكروبات التلقائيه\n♪︙سيتم ارسال نسخه تلقائيه للكروبات كل يوم الى خاص المطور الاساسي", 1, 'md')
...
DevAbs(msg.chat_id_,msg.id_, 1, "♪︙تم تعطيل جلب نسخة الكروبات التلقائيه", 1, 'md')
DevAbs:set(WaTaN2.."Abs:Lock:AutoFile",true) 
end
end
end
--     Source WaTaN2     --
if text == "اهمس" or text == "همسه" or text == "اريد بوت الهمسه" or text == "دزلي بوت الهمسه" or  text == "دزولي بوت الهمسه" then  DevAbs(msg.chat_id_, msg.id_, 1, '♪︙@NW3bot', 1, 'md') end
...
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevAbs:get(ReLaX..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) DevAbs(msg.chat_id_, msg.id_, 1, "♪︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevAbs:get(ReLaX..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  DevAbs(msg.chat_id_, msg.id_, 1, "♪︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
if text == "ايديي" and ChCheck(msg) then DevAbs(msg.chat_id_, msg.id_, 1,'♪︙ايديك ↫ ❨ `'..msg.sender_user_id_..'` ❩', 1, 'md') end
if text == "رتبتي" and ChCheck(msg) then DevAbs(msg.chat_id_, msg.id_, 1, '♪︙رتبتك ↫ '..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'html') end
if text == "ايدي المجموعه" and ChCheck(msg) then DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ايدي المجموعه ↫ `"..msg.chat_id_.."`", 1, 'md') end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevAbs:del(ReLaX..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevAbs:del(ReLaX..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, ''..WaTaNTeaM[math.random(#WaTaNTeaM)]..'' , 1, 'md')  
return false
end
--     Source WaTaN2     --
if text and (text == 'المطور' or text == 'مطور' or text == '↫  المطور ♪') and not DevAbs:get(WaTaN2..'Abs:Devinline:Pv'..msg.chat_id_) then
...
DevAbs(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
...
--     Source WaTaN2     --
if text == "الالعاب المتطوره" or text == "الالعاب الاحترافيه" or text == "↫ الالعاب المتطوره ♪" then if not DevAbs:get(WaTaN2..'Abs:Lock:Gamesinline'..msg.chat_id_) then local inline = {{{text=" ♟ الشطرنج ♟ ",url='https://t.me/T4TTTTBOT?game=chess'}},{{text=" لعبة فلابي بيرد 🐥 ",url='https://t.me/awesomebot?game=FlappyBird'},{text=" تحدي الرياضيات ",url='https://t.me/gamebot?game=MathBattle'}},{{text=" اكس او ",url='t.me/xobot?start'},{text=" سباق الدراجات 🏍 ",url='https://t.me/gamee?game=MotoFX'}},{{text=" سباق سيارات 🏎 ",url='https://t.me/gamee?game=F1Racer'},{text=" متشابه 👾 ",url='https://t.me/gamee?game=DiamondRows'}},{{text=" كرة قدم ⚽ ",url='https://t.me/gamee?game=FootballStar'}},{{text=" ورق🤹‍♂ ",url='https://t.me/gamee?game=Hexonix'},{text=" Hexonix❌ ",url='https://t.me/gamee?game=Hexonix'}},{{text=" MotoFx🏍️ ",url='https://t.me/gamee?game=MotoFx'}},{{text=" لعبة 2048 🎰 ",url='https://t.me/awesomebot?game=g2048'},{text=" Squares🏁 ",url='https://t.me/gamee?game=Squares'}},{{text=" Atomic 1▶️ ",url='https://t.me/gamee?game=AtomicDrop1'},{text=" Corsairs ",url='https://t.me/gamebot?game=Corsairs'}},{{text=" LumberJack ",url='https://t.me/gamebot?game=LumberJack'}},{{text=" LittlePlane ",url='https://t.me/gamee?game=LittlePlane'},{text=" RollerDisco ",url='https://t.me/gamee?game=RollerDisco'}},{{text=" 🦖 لعبة التنين 🦖 ",url='https://t.me/T4TTTTBOT?game=dragon'},{text=" 🐍 لعبة الافعى 🐍 ",url='https://t.me/T4TTTTBOT?game=snake'}},{{text=" 🔵 لعبة الالوان 🔴 ",url='https://t.me/T4TTTTBOT?game=color'}},{{text=" 🚀 لعبة الصاروخ 🚀 ",url='https://t.me/T4TTTTBOT?game=rocket'},{text=" 🏹 لعبة السهام 🏹 ",url='https://t.me/T4TTTTBOT?game=arrow'}},{{text=" لعبة النينجا ",url='https://t.me/gamee?game=GravityNinja21'},{text=" لعبة الكرتي ",url='https://t.me/gamee?game=KarateKid2'}},{{text=' ♪ ReLaX TeAM . •', url="t.me/PPPTP"}}} SendInline(msg.chat_id_,'*♪︙قائمه الالعاب المتطوره اضغط للعب*',nil,inline,msg.id_/2097152/0.5) return false end end
--     Source WaTaN2     --
if text and text:match("^غادر (-%d+)$")  then
local Text = { string.match(text, "^(غادر) (-%d+)$")}
if not SecondSudo(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمطور الاساسي فقط', 1, 'md')
else 
tdcli_function({ID ="GetChat",chat_id_=Text[2]},function(arg,dp) 
if dp.id_ then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙المجموعه ↫ ["..dp.title_.."]\n♪︙تمت المغادره منها بنجاح", 1, "md")
DevAbs(Text[2], 0, 1, "♪︙بامر المطور تم مغادرة هذه المجموعه ", 1, "md")  
ChatLeave(dp.id_, WaTaN2)
DevAbs:srem(WaTaN2.."Abs:Groups", dp.id_)
else
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لم تتم اضافتي بها لاقوم بمغادرتها", 1, "md")
end 
end,nil)
end 
end
...
if ChatType =='pv' then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لاتستطيع تفعيلي هنا يرجى اضافتي في مجموعه اولا', 1, 'md')
return false
end
if ChatType ~='sp' then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙المجموعه عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل المجموعه ضاهر وليس مخفي ومن بعدها يمكنك رفعي ادمن ثم تفعيلي', 1, 'md')
return false
end
if msg.can_be_deleted_ == false then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙البوت ليس ادمن يرجى ترقيتي !', 1, 'md')
return false  
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevAbs:get(WaTaN2..'Abs:Num:Add:Bot') or 0) and not SecondSudo(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙عدد اعضاء المجموعه اقل من ↫ *'..(DevAbs:get(WaTaN2..'Abs:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع تفعيل هذه المجموعه بسبب تعطيل البوت الخدمي من قبل المطور الاساسي', 1, 'md') 
end 
end 
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevAbs:del(WaTaN2..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if text == "الغاء" then 
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙♪︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevAbs:del(WaTaN2..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if #List == 4 then 
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ ↫ 5 من الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevAbs:del(WaTaN2..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
return false
end
...
SendInline(msg.chat_id_,Ali,nil,inline)
return false
end
end
...
if text == "الغاء" then 
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙♪︙تم الغاء عملية حفظ اسئلة الكت  ↫ "..GetKtTexts ,  1, "md")
...
if #List == 100 then 
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ ↫ 100 من اسئلة الكت ↫ "..GetKtTexts ,  1, "md")
DevAbs:del(WaTaN2..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
return false
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ الرد', 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ الرد الجديد', 1, 'md') 
DevAbs:del(WaTaN2..'Abs:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(WaTaN2..'DelManagerRep'..msg.chat_id_)
return false 
end 
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙عدد مشاهدات المنشور هي ↫ ('..msg.views_..')', 1, 'md')
DevAbs:del(WaTaN2..'Abs:viewget'..msg.sender_user_id_)
end
end
--     Source WaTaN2     --
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@PPPTP]'))
DevAbs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end 
...
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = WaTaN2,offset_ = 0,limit_ = 1},function(extra,rio,success) 
...
if DevAbs:get(WaTaN2.."Abs:Text:BotWelcome") then AliText = DevAbs:get(WaTaN2.."Abs:Text:BotWelcome") else AliText = "♪︙مرحبا انا بوت اسمي "..NameBot.."\n♪︙حالة المجموعه ↫ "..BotText.."\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉" end 
if DevAbs:get(WaTaN2.."Abs:Photo:BotWelcome") then AliPhoto = DevAbs:get(WaTaN2.."Abs:Photo:BotWelcome") elseif rio.photos_[0] then AliPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else AliPhoto = nil end 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@PPPTP]'))
DevAbs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source WaTaN2     --
--        Contact         --
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ الرابط بنجاح', 1, 'md')
DevAbs:del(WaTaN2.."Abs:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false 
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء الامر', 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_,  1, "♪︙تم اضافة "..numadded..' رساله', 1, 'md')
DevAbs:del('WaTaNTeaM:'..WaTaN2..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
...
DevAbs(msg.chat_id_, msg.id_,  1, "♪︙تم اضافة "..numadded..' نقطه', 1, 'md')
DevAbs:del('WaTaNTeaM:'..WaTaN2..'ids:user'..msg.chat_id_)  
end
end
--     Source WaTaN2     --
...
local Users = DevAbs:smembers(WaTaN2..'Abs:Users') 
local BotName = (DevAbs:get(WaTaN2.."Abs:NameBot") or 'ريلاكس')
...
AliConstructors = DevAbs:smembers(WaTaN2..'Abs:AbsConstructor:'..v)
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..WaTaN2..'.json', '♪︙يحتوي الملف على ↫ ⤈\n*♪︙مجموعه*'..#List..' \n*♪︙مشترك*'..#Users..' ' ,dl_cb, nil)
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ كليشة المطور", 1, "md")
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ اسم البوت ', 1, 'html')
DevAbs:del(WaTaN2..'Abs:NameBot'..msg.sender_user_id_)
...
DevAbs(msg.chat_id_, msg.id_, 1, WaTaNTeaM[DevAbs2] , 1, 'html') 
return false
end
...
if text and text == (DevAbs:get(WaTaN2..'Abs:NameBot') or 'ريلاكس') then 
NameBot = (DevAbs:get(WaTaN2..'Abs:NameBot') or 'ريلاكس')
local namebot = {'كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' '} 
name = math.random(#namebot) 
DevAbs(msg.chat_id_, msg.id_, 1, namebot[name] , 1, 'html') 
return false 
end
if text =='نقاطي' and ChCheck(msg) then 
if tonumber((DevAbs:get(WaTaN2..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙لم تربح اي نقطه\n♪︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙عدد النقاط التي ربحتها ↫ '..(DevAbs:get(WaTaN2..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAbs:del(WaTaN2..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حذف جميع نقاطك', 1, 'md') end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1,WaTaNTeaM, 1, 'md')
return false
end end
...
DevAbs(msg.chat_id_, msg.id_, 1, TEST, 1, "md") 
...
DevAbs(msg.chat_id_, msg.id_, 1,"♪︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
...
DevAbs:incrby(WaTaN2..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙*التخمين الصحيح هو* ↫ '..NUM..'\n♪︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
...
DevAbs:del(WaTaN2..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevAbs:del(WaTaN2.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n♪︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙لقد خمنت الرقم الخطا وتبقى لديك '..SetNum..' ارسل رقم تخمنه مره اخرى للفوز', 1, 'md')
end
end
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n♪︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n♪︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙المعرف غير صحيح يرجى ارسال معرف صحيح', 1, 'md')
return false 
end
...
Text =''..WaTaNTeaM[math.random(#WaTaNTeaM)]..''
local inline = {{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
return false
end
end
...
local inline = {{{text=" مسح رسائلي ",callback_data="/DelMsg:"..msg.sender_user_id_},{text=" مسح سحكاتي ",callback_data="/DelEdit:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end
--     Source WaTaN2     --
...
local inline = {{{text=" غنيلي ",callback_data="/Song:"..msg.sender_user_id_},{text=" اغنيه ",callback_data="/mp3:"..msg.sender_user_id_}},{{text=" متحركه ",callback_data="/gif:"..msg.sender_user_id_},{text=" صوره ",callback_data="/photo:"..msg.sender_user_id_}},{{text=" انمي ",callback_data="/anime:"..msg.sender_user_id_},{text=" ريمكس ",callback_data="/remix:"..msg.sender_user_id_}},{{text=" ميمز ",callback_data="/memz:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end
--     Source WaTaN2     --
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text=" رفع ادمن ",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text=" رفع منشئ ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text=" رفع مدير ",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text=" رفع منظف ",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text=" رفع منشئ اساسي ",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text=" رفع مالك ",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text=" رفع مطور ",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text=" رفع مطور ثانوي ",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_},{text=" رفع مطور اساسي ",callback_data=msg.sender_user_id_..":SetAliSudo:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif AliSudo(msg) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text=" رفع ادمن ",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text=" رفع منشئ ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text=" رفع مدير ",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text=" رفع منظف ",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text=" رفع منشئ اساسي ",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text=" رفع مالك ",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text=" رفع مطور ",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text=" رفع مطور ثانوي ",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif SecondSudo(msg) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text=" رفع ادمن ",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text=" رفع منشئ ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text=" رفع مدير ",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text=" رفع منظف ",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text=" رفع منشئ اساسي ",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text=" رفع مالك ",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text=" رفع مطور ",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif SudoBot(msg) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text=" رفع ادمن ",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text=" رفع منشئ ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text=" رفع مدير ",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text=" رفع منظف ",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text=" رفع منشئ اساسي ",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text=" رفع مالك ",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Owner(msg) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text=" رفع ادمن ",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text=" رفع منشئ ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text=" رفع مدير ",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text=" رفع منظف ",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text=" رفع منشئ اساسي ",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text=" رفع ادمن ",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text=" رفع منشئ ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text=" رفع مدير ",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text=" رفع منظف ",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text=" رفع ادمن ",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text=" رفع منظف ",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text=" رفع مدير ",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text=" رفع ادمن ",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text=" رفع مميز ",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
end
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text=" تنزيل ادمن ",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text=" تنزيل منشئ ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text=" تنزيل مدير ",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text=" تنزيل منظف ",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text=" تنزيل منشئ  اساسي ",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text=" تنزيل مالك ",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text=" تنزيل مطور ",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text=" تنزيل مطور ثانوي ",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_},{text=" تنزيل مطور اساسي ",callback_data=msg.sender_user_id_..":RemAliSudo:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif AliSudo(msg) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=msg.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=msg.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=msg.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=msg.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=msg.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل منشئ  اساسي ",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Ali}},{{text=" تنزيل مالك ",callback_data=msg.sender_user_id_..":RemOwner:"..Ali},{text=" تنزيل مطور ",callback_data=msg.sender_user_id_..":RemSudoBot:"..Ali}},{{text=" تنزيل مطور ثانوي ",callback_data=msg.sender_user_id_..":RemSecondSudo:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif SecondSudo(msg) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=msg.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=msg.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=msg.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=msg.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=msg.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل منشئ  اساسي ",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Ali}},{{text=" تنزيل مالك ",callback_data=msg.sender_user_id_..":RemOwner:"..Ali},{text=" تنزيل مطور ",callback_data=msg.sender_user_id_..":RemSudoBot:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif SudoBot(msg) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=msg.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=msg.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=msg.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=msg.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=msg.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل منشئ  اساسي ",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Ali}},{{text=" تنزيل مالك ",callback_data=msg.sender_user_id_..":RemOwner:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Owner(msg) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=msg.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=msg.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=msg.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=msg.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=msg.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل منشئ  اساسي ",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=msg.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=msg.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منشئ ",callback_data=msg.sender_user_id_..":RemConstructor:"..Ali},{text=" تنزيل مدير ",callback_data=msg.sender_user_id_..":RemManager:"..Ali}},{{text=" تنزيل منظف ",callback_data=msg.sender_user_id_..":RemCleaner:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=msg.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=msg.sender_user_id_..":RemAdmin:"..Ali}},{{text=" تنزيل منظف ",callback_data=msg.sender_user_id_..":RemCleaner:"..Ali},{text=" تنزيل مدير ",callback_data=msg.sender_user_id_..":RemManager:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=msg.sender_user_id_..":RemMem:"..Ali},{text=" تنزيل ادمن ",callback_data=msg.sender_user_id_..":RemAdmin:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text=" تنزيل مميز ",callback_data=msg.sender_user_id_..":RemMem:"..Ali}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
local inline = {{{text=" الرابط نص ",callback_data="/LinkText:"..msg.sender_user_id_},{text=" الرابط انلاين ",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end
--     Source WaTaN2     --
...
local inline = {{{text=" الالعاب المتطوره ",callback_data="/GameInline:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end
end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙تم بيع '..(DevAbs:get(WaTaN2..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n♪︙كل نقطه تساوي 50 رساله', 'md')
...
if num == 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لا يوجد ادمنيه ليتم رفعهم\n♪︙تم رفع مالك المجموعه", 1, 'md')
else
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم رفع '..num..' من الادمنيه \n♪︙تم رفع مالك المجموعه', 1, 'md')
end
end,nil) 
end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙موقعك ↫ '..rtpa, 1, 'md')
end,nil)
end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙اسمك ↫ ❨ ['..result.first_name_..'] ❩\n♪︙معرفك ↫ ❨ ['..username..'] ❩\n♪︙ايديك ↫ ❨ `'..result.id_..'` ❩\n♪︙نقاطك ↫ ❨ '..user_nkt..' ❩\n♪︙رسائلك ↫ ❨ '..user_msgs..' ❩\n♪︙جهاتك ↫ ❨ '..cont..' ❩\n♪︙تفاعلك ↫ '..formsgs(msguser)..'\n♪︙رتبتك ↫ '..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'md')
end
...
DevAbs:del(WaTaN2..'Abs:ChId')
DevAbs(msg.chat_id_, msg.id_, 1,"♪︙تم حذف قناة الاشتراك الاجباري", 1, 'md') 
end
end
if SecondSudo(msg) then
...
function WaTaNTeaM(extra,result,success)
if DevAbs:get(WaTaN2.."Abs:Send:Bot"..WaTaN2) and not AliSudo(msg) then 
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم اذاعة رسالتك بالتوجيه \n♪︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n♪︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙حسنا قم باعادة توجيه للمنشور الذي تريدني حساب مشاهداته', 1, 'md')
end
--     Source WaTaN2     --
...
Text = [[
Welcome To Source
♪︙[♪ ReLaX TeAM .](https://t.me/PPPTP)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text='♪ Source Channel',url="https://t.me/PPPTP"}},{{text='♪ Developer',url="t.me/AAAPA"},{text='♪ Tws ReLaX',url="https://t.me/N5zbot"}},{{text='♪ Exp Source',url="https://t.me/Relaxfiles"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PPPTP&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
...
DevAbs(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
...
local user_msgs = DevAbs:get(WaTaN2..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙عدد رسائلك هنا ↫ *❨ "..user_msgs.." ❩*", 1, 'md')
end
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙انضمام الاعضاء اليوم ↫ *"..EntryNumber.."*\n♪︙مغادرة الاعضاء اليوم ↫ *"..ExitNumber.."*\n♪︙عدد الرسائل اليوم ↫ *"..MsgNumberDay.."*\n♪︙نسبة التفاعل اليوم ↫ *"..math.random(40,100).."%*", 1, 'md')
end
--     Source WaTaN2     --
...
--     Source WaTaN2     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevAbs:get(WaTaN2..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) DevAbs(msg.chat_id_, msg.id_, 1, "♪︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevAbs:get(WaTaN2..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  DevAbs(msg.chat_id_, msg.id_, 1, "♪︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
if text == "رتبتي" and ChCheck(msg) then DevAbs(msg.chat_id_, msg.id_, 1, '♪︙رتبتك ↫ '..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'html') end
if text == "ايدي المجموعه" and ChCheck(msg) then DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ايدي المجموعه ↫ `"..msg.chat_id_.."`", 1, 'md') end
if text =='مسح جهاتي' or text =='مسح اضافاتي' or text =='حذف جهاتي' or text =='حذف اضافاتي' then DevAbs:del(WaTaN2..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md')  
return false 
end  
if tonumber(result.id_) == tonumber(DevId) then 
DevAbs(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
DevAbs(msg.chat_id_, result.id_, 1,''..WaTaNTeaM[math.random(#WaTaNTeaM)], 1, 'html') 
else  
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
...
DevAbs(msg.chat_id_, result.id_, 1,''..WaTaNTeaM[math.random(#WaTaNTeaM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
if tonumber(result.sender_user_id_) == tonumber(WaTaN2) then 
DevAbs(msg.chat_id_, msg.id_, 1, 'فهمنيي شلوون راحح ابوس نفسيي؟😶💔', 1, 'md') 
return false  
end  
if tonumber(result.sender_user_id_) == tonumber(DevId) then  
DevAbs(msg.chat_id_, result.id_, 1, 'مواححح احلاا بوسةة المطوريي😻🔥💗', 1, 'html')
return false
end 
local WaTaNTeaM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
DevAbs(msg.chat_id_, msg.id_, 1,WaTaNTeaM, 1, 'md') 
...
if tonumber(result.sender_user_id_) == tonumber(WaTaN2) then 
DevAbs(msg.chat_id_, msg.id_, 1, 'فهمنيي شلوون راحح اصيح نفسيي؟😶💔', 1, 'md') 
return false  
end  
if tonumber(result.sender_user_id_) == tonumber(DevId) then  
DevAbs(msg.chat_id_, result.id_, 1, 'تعال مطوريي محتاجيكك🏃🏻‍♂️♥️', 1, 'html')
return false
end 
local WaTaNTeaM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
DevAbs(msg.chat_id_, msg.id_, 1,WaTaNTeaM, 1, 'md') 
...
if tonumber(result.id_) == tonumber(DevId) then 
DevAbs(msg.chat_id_, msg.id_, 1, 'تعال مطوريي محتاجيكك🏃🏻‍♂️♥️ @'..username, 1, 'html') 
return false  
end  
local WaTaNTeaM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
DevAbs(msg.chat_id_, msg.id_, 1,WaTaNTeaM, 1, 'md') 
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لاتستطيع تنزيل المطور الاساسي", 1, 'md')
return false 
end
...
elseif AliDelAll(msg.sender_user_id_,msg.chat_id_) =='riosudo' then
DevAbs:srem(WaTaN2..'Abs:SecondSudo:', result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:SudoBot:', result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:Owner:'..msg.chat_id_,result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
DevAbs:srem(WaTaN2..'Abs:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:Owner:'..msg.chat_id_,result.sender_user_id_)
elseif AliDelAll(msg.sender_user_id_,msg.chat_id_) =='owner' then
DevAbs:srem(WaTaN2..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:Cleaner:'..msg.chat_id_, result.sender_user_id_)
elseif AliDelAll(msg.sender_user_id_,msg.chat_id_) =='rioconstructor' then
DevAbs:srem(WaTaN2..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(WaTaN2..'Abs:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
Alisudo ='المطورين الاساسيين • ' else Alisudo ='' end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا يمكن تنزيل المالك الاساسي', 1, 'md')
else
DevAbs:srem(WaTaN2..'Abs:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function raf_reply(extra, result, success)
if not AliConstructor(msg) and DevAbs:get(WaTaN2.."Abs:Lock:ProSet"..msg.chat_id_) then 
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙هذا الامر للمالكين والمطورين فقط', 1, 'md')
end
--     Source WaTaN2     --
--    Set  Constructor    --
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙ليست لدي صلاحية اضافة مشرفين جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم تفعيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source WaTaN2     --
--          Kick          --
...
if not AliConstructor(msg) and DevAbs:get(WaTaN2.."Abs:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'♪︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if RankChecking(result.sender_user_id_, result.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع طرد ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
...
local inline = {{{text=" الغاء حظر ",callback_data=msg.sender_user_id_..":UnBan:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end,nil)
end
end 
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع طرد ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع طرد ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع حظر ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"♪︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع حظر ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"♪︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
if RankChecking(user, msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع حظر ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=user,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"♪︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
if not AliConstructor(msg) and DevAbs:get(WaTaN2.."Abs:Lock:MuteTked"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'♪︙لقد تم تعطيل الكتم والتقيد')
return false
end
if RankChecking(result.sender_user_id_, result.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع كتم ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
...
local inline = {{{text=" الغاء كتم ",callback_data=msg.sender_user_id_..":UnMute:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end
end
end 
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع كتم ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
...
if RankChecking(user, msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع كتم ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع تقيد ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_)
DevAbs:sadd(WaTaN2..'Abs:Tkeed:'..msg.chat_id_, result.sender_user_id_)
local Text = "♪︙تم تقيده من المجموعه" 
local inline = {{{text=" الغاء تقيد ",callback_data=msg.sender_user_id_..":UnTkeed:"..result.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع تقيد ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
...
if RankChecking(user, msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا تستطيع تقيد ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
...
if tonumber(result.sender_user_id_) == tonumber(WaTaN2) then  
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
if SudoId(result.sender_user_id_) == true then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
...
if DevAbs:sismember(WaTaN2..'Abs:SecondSudo:',result.sender_user_id_) and not AliSudo(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
...
local inline = {{{text=" الغاء العام ",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
if DevAbs:sismember(WaTaN2..'Abs:SecondSudo:',result.id_) and not AliSudo(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
...
if DevAbs:sismember(WaTaN2..'Abs:SecondSudo:',user) and not AliSudo(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
...
if tonumber(result.sender_user_id_) == tonumber(WaTaN2) then  
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع كتم البوت عام*", 1, 'md')
return false 
end
if SudoId(result.sender_user_id_) == true then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع كتم المطور الاساسي*", 1, 'md')
return false 
end
if DevAbs:sismember(WaTaN2..'Abs:AbsSudo:',result.sender_user_id_) and not Sudo(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع كتم المطور الاساسي*", 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل عدد الرسائل الان \n♪︙ارسل الغاء لالغاء الامر ", 1, "md")
DevAbs(msg.chat_id_, msg.id_, 1,numd, 1, 'md') 
else 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙هذا الامر للمنشئين فقط', 1, 'md') 
end 
end 
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم اضافة "..Num..' رساله', 1, 'md') 
end
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل عدد النقاط الان \n♪︙ارسل الغاء لالغاء الامر ", 1, "md")
DevAbs(msg.chat_id_, msg.id_, 1,numd, 1, 'md') 
else 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙هذا الامر للمنشئين فقط', 1, 'md') 
end 
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
...
DevAbs(msg.chat_id_,msg.id_, 1, "♪︙التثبيت والغاء واعادة التثبيت تم قفله من قبل المنشئين الاساسيين", 1, 'md')
return false  
end
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙البوت ليس ادمن هنا !', 1, 'md')
return false  
end
if data.message_ == "CHAT_ADMIN_REQUIRED" then
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات', 1, 'md')
return false  
end
end,nil)
end 
...
local inline = {{{text=" مسح المميزين ",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end end
--     Source WaTaN2     --
if Manager(msg) then
...
local List = DevAbs:smembers(WaTaN2..rio)
text = "♪︙قائمة الادمنيه ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(WaTaN2..'Save:UserName'..v)
if username then
...
local inline = {{{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end end
--     Source WaTaN2     -- 
if Constructor(msg) then
...
local inline = {{{text=" مسح المدراء ",callback_data="/DelManagers:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end 
...
local inline = {{{text=" مسح المنظفين ",callback_data="/DelCleanr:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end end
--     Source WaTaN2     --
if BasicConstructor(msg) then
...
local inline = {{{text=" مسح المنشئين ",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end end
--     Source WaTaN2     --
if Owner(msg) then
...
local inline = {{{text=" مسح المالكين ",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
...
local inline = {{{text=" مسح المنشئين الاساسيين ",callback_data="/DelBasicConstructor:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end 
end 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or PPPTP}}}
local msg_id = msg.id_/2097152/0.5
...
local inline = {{{text=" مسح المكتومين ",callback_data="/DelMute:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
--     Source WaTaN2     --
...
local inline = {{{text=" مسح المقيدين ",callback_data="/DelKeed:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
--     Source WaTaN2     --
...
local inline = {{{text=" مسح المحظورين ",callback_data="/DelBan:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
--     Source WaTaN2     --
...
--     Source WaTaN2     --
if text == "قائمه المنع" and AliConstructor(msg) and ChCheck(msg) then
...
local inline = {{{text=" مسح المتحركات ",callback_data="/DelGif:"..msg.sender_user_id_},{text=" مسح الملصقات ",callback_data="/DelSticker:"..msg.sender_user_id_}},{{text=" مسح الصور ",callback_data="/DelPhoto:"..msg.sender_user_id_},{text=" مسح الكلمات ",callback_data="/DelTextfilter:"..msg.sender_user_id_}},{{text=" مسح قوائم المنع ",callback_data="/DelAllFilter:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
end 
--     Source WaTaN2     --
if text == "المطورين الاساسيين" and ChCheck(msg) and AliSudo(msg) or text == "الاساسيين" and AliSudo(msg) and ChCheck(msg) or text == "↫ الاساسيين ♪" and AliSudo(msg) and ChCheck(msg) then 
...
local inline = {{{text=" مسح الاساسيين ",callback_data="/DelAliSudo:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end 
--     Source WaTaN2     --
...
local inline = {{{text=" مسح الثانويين ",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
--     Source WaTaN2     --
if SudoBot(msg) then
...
local inline = {{{text=" مسح قائمه العام ",callback_data="/DelListAll:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end 
--     Source WaTaN2     --
...
local inline = {{{text=" مسح المطورين ",callback_data="/DelSudoBot:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
--     Source WaTaN2     --
...
tdcli_function ({ID = "GetUser",user_id_ = Manager_id},function(arg,dp) 
if dp.first_name_ == false then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙حساب المنشئ محذوف", 1, "md")
return false  
end
local UserName = (dp.username_ or "PPPTP")
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم رفع مالك المجموعه ↫ ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md") 
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم منع الملصق بنجاح لن يتم ارساله مجددا', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevAbs:sadd(WaTaN2.."Abs:FilterPhoto"..msg.chat_id_,photo)
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم منع الصوره بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
if result.content_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevAbs:sadd(WaTaN2.."Abs:FilterAnimation"..msg.chat_id_,idanimation)
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم منع المتحركه بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevAbs:srem(WaTaN2.."Abs:FilterPhoto"..msg.chat_id_,photo)
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevAbs:srem(WaTaN2.."Abs:FilterAnimation"..msg.chat_id_,idanimation)
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء منع المتحركه يمكنهم ارسالها الان', 1, 'md')
return false
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙معرفه ↫ [@'..data.username_..']\n♪︙ايديه ↫ ❨ `'..result.sender_user_id_..'` ❩\n♪︙رتبته ↫ '..IdRank(result.sender_user_id_, msg.chat_id_)..sudobot..'\n♪︙رسائله ↫ ❨ '..user_msgs..' ❩\n♪︙تفاعله ↫ '..formsgs(user_msgs)..CustomTitle..'\n♪︙نقاطه ↫ ❨ '..user_nkt..' ❩'..Tked, 1, 'md')
end
end,nil)
end 
...
DevAbs(msg.chat_id_, msg.id_, 1,chn, 1, 'md')
else
local gr ='مجموعه'
local grr ='♪︙نوع الحساب ↫ ❨ '..gr..' ❩\n♪︙الايدي ↫ ❨ '..res.id_..' ❩\n♪︙المعرف ↫ ❨ [@'..username..'] ❩\n♪︙الاسم ↫ ❨ ['..res.title_..'] ❩'
DevAbs(msg.chat_id_, msg.id_, 1,grr, 1, 'md')
end
return false  end
if res.id_ then  
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙لم يتم التعرف على الحساب', 1, 'md')
return false  
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الحظر العام ↫ '..banall..'\n♪︙الكتم العام ↫ '..muteall..'\n♪︙الحظر ↫ '..banned..'\n♪︙الكتم ↫ '..muted..'\n♪︙التقيد ↫ '..tkeed, 1, 'md')  
end
...
function unbanreply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(WaTaN2) then  
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙انا البوت وليس لدي قيود', 1, 'md')  
return false  
end 
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لم استطع استخراج المعلومات', 1, 'md') 
return false  
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙هذا معرف قناة وليس معرف حساب', 1, 'md') 
return false  
end
if tonumber(result.id_) == tonumber(WaTaN2) then  
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙انا البوت وليس لدي قيود', 1, 'md')  
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙رجائا اتبع التعليمات للتعيين \n♪︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉', 1, 'md')
...
if text =='الغاء' then   
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAbs:del("WaTaN2:New:id:"..WaTaN2..msg.sender_user_id_)
return false
end
DevAbs:del("WaTaN2:New:id:"..WaTaN2..msg.sender_user_id_)
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ كليشة الايدي العامه', 1, 'md')
...
DevAbs:del("WaTaN2:New:id:"..WaTaN2..msg.chat_id_..msg.sender_user_id_)
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ الكليشه الجديده', 1, 'md')
...
function WaTaNTeaM(extra,rio,success)
...
if not DevAbs:get(WaTaN2.."Abs:GpIds:Text"..msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, newallid, 1, 'html')
else
local new_id = DevAbs:get(WaTaN2.."Abs:GpIds:Text"..msg.chat_id_)
local new_id = new_id:gsub('#username',(username or 'لا يوجد'))
local new_id = new_id:gsub('#CustomTitle',(CustomTitle or 'لا يوجد'))
...
local new_id = new_id:gsub('#stast',(IdRank(msg.sender_user_id_, msg.chat_id_) or 'لا يوجد'))
local new_id = new_id:gsub('#Description',(Description or 'لا يوجد'))
DevAbs(msg.chat_id_, msg.id_, 1, new_id, 1, 'html')  
end
end
else
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙عذرا الايدي معطل ', 1, 'md')
end
else
if DevAbs:get(WaTaN2.."Abs:AllIds:Text") then
...
if not DevAbs:get(WaTaN2..'Abs:Lock:Id'..msg.chat_id_) then
if not DevAbs:get(WaTaN2..'Abs:Lock:Id:Photo'..msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, notpicid, 1, 'html')
else
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙معرفك ↫ ❨ "..username.." ❩\n♪︙ايديك ↫ ❨ "..msg.sender_user_id_.." ❩\n♪︙رتبتك ↫ "..IdRank(msg.sender_user_id_, msg.chat_id_).."\n♪︙رسائلك ↫ ❨ "..user_msgs.." ❩\n♪︙سحكاتك ↫ ❨ "..edit_msg.." ❩\n♪︙رسائلك ↫ ❨ "..user_msgs.." ❩\n♪︙تفاعلك ↫ "..formsgs(msguser).."\n♪︙نقاطك ↫ ❨ "..user_nkt.." ❩", 1, 'md')
end
else
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙عذرا الايدي معطل', 1, 'md')
end end end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙التعديل بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تعديل الميديا بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الفارسيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الفشار بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الطائفيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الكفر بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الفارسيه بالطرد بالفعل مقفله ', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙التثبيت بالفعل مقفل في المجموعه', 1, 'md')
end end end
end
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙قم بتحديد عدد اكبر من 2 للتكرار', 1, 'md')
else
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم وضع عدد التكرار ↫ '..TextSpam, 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم وضع زمن التكرار ↫ '..TextSpam, 1, 'md')
end
--     Source WaTaN2     --
if Manager(msg) then
if text and text =='تفعيل الايدي بالصوره' and ChCheck(msg) then
if not DevAbs:get(WaTaN2..'Abs:Lock:Id:Photo'..msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الايدي بالصوره بالتاكيد مفعل', 1, 'md')
else
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
...
if not DevAbs:get(WaTaN2..'Abs:Lock:Id'..msg.chat_id_) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الايدي بالتاكيد مفعل ', 1, 'md')
else
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الايدي بالتاكيد معطل ', 1, 'md')
else
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙ارسل رابط المجموعه او رابط قناة المجموعه', 1, 'md')
...
LinkGroup = LinkGp.result
DevAbs:set(WaTaN2.."Abs:Groups:Links"..msg.chat_id_,LinkGroup) 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم انشاء رابط جديد ارسل ↫ الرابط', 1, 'md')
else
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙ليست لدي صلاحية دعوة المستخدمين عبر الرابط يرجى التحقق من الصلاحيات', 1, 'md')
end
else
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙ارسل رابط المجموعه او رابط قناة المجموعه', 1, 'md')
DevAbs:setex(WaTaN2.."Abs:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
...
if text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ كليشة الترحيب', 1, 'md')
return false   
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙ارسل لي الترحيب الان\n♪︙تستطيع اضافة مايلي ↫ ⤈\n♪︙دالة عرض الاسم ↫ firstname\n♪︙دالة عرض المعرف ↫ username', 1, 'md')
...
if text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر المنع', 1, 'md')
DevAbs:del(WaTaN2.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم منع الكلمه ↫ "..text, 1, 'html')
DevAbs:del(WaTaN2.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
...
if text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر الغاء المنع', 1, 'md')
DevAbs:del(WaTaN2.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevAbs:hget(WaTaN2..'Abs:Filters:'..msg.chat_id_, text) then  
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevAbs:del(WaTaN2.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevAbs:hdel(WaTaN2..'Abs:Filters:'..msg.chat_id_, text)
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙الكلمه ↫ "..text.." تم الغاء منعها", 1, 'html')
DevAbs:del(WaTaN2.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
end
return false
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙احصائيات البوت ↫ ⤈\n♪︙عدد المشتركين ↫ ❨ '..users..' ❩\n♪︙عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙عدد المشتركين ↫ ❨ '..users..' ❩', 1, 'md')
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
end
--     Source WaTaN2     --
if text and text == "المجموعات" and ChCheck(msg) or text and text == "↫ المجموعات ♪" and ChCheck(msg) then
if not SudoBot(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمطورين فقط ', 1, 'md')
else
local list = DevAbs:smembers(WaTaN2.."Abs:Groups")
...
DevAbs(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end end
--     Source WaTaN2     --
...
if Number > 5000 then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لاتستطيع تنظيف اكثر من 5000 رساله', 1, 'md')
return false  
end  
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم تنظيف *'..Number..'* من الرسائل', 1, 'md')
...
if #pv == i then 
if sendok == 0 then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙*لا يوجد مشتركين وهميين*', 1, 'md')
else
local ok = #pv - sendok
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙عدد المشتركين الان ↫ { '..#pv..' }\n♪︙تم حذف ↫ { '..sendok..' } من المشتركين\n♪︙العدد الحقيقي الان  ↫ ( '..ok..' ) \n', 1, 'md')
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙*لاتوجد مجموعات وهميه*', 1, 'md')   
else
local WaTaN2gp2 = (w + q)
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙عدد الكروبات الان ↫ { '..#group..' }'..WaTaN2gp1..WaTaN2gp2..'\n♪︙العدد الحقيقي الان  ↫ ( '..WaTaN2gp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙قم بتحديد عدد اكبر من 10 واصغر من 1000 للحذف التلقائي', 1, 'md')
else
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم وضع ↫ *'..Num..'* من الميديا للحذف التلقائي', 1, 'md')
...
if M ~= 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙عدد الميديا ↫ "..M.."\n♪︙الحذف التلقائي ↫ "..(DevAbs:get(WaTaN2..'Abs:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لاتوجد ميديا هنا", 1, 'md') 
end end
end
end
--     Source WaTaN2     --
...
if M ~= 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙عدد الميديا ↫ "..M, 1, 'md') 
else
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لاتوجد ميديا هنا", 1, 'md') 
end end
...
if Del ~= 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حذف "..Del.." من الميديا", 1, 'md') 
...
if M ~= 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙عدد الاغاني ↫ "..M, 1, 'md') 
else
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لاتوجد اغاني هنا", 1, 'md') 
end end
...
if Del ~= 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حذف "..Del.." من الاغاني", 1, 'md') 
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم تنظيف 100 من الرسائل المعدله', 1, 'md')
end
--     Source WaTaN2     --
if ChatType =='sp' or ChatType =='gp'  then
if Admin(msg) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙التعديل بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if AliConstructor(msg) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تعديل الميديا بالفعل مفتوح في المجموعه', 1, 'md')
end
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الفارسيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الفشار بالفعل مفتوح في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الطائفيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الكفر بالفعل مفتوح في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الفارسيه بالطرد بالفعل مفتوحه', 1, 'md')
end
end
if AliConstructor(msg) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙التثبيت بالفعل مفتوح في المجموعه', 1, 'md')
end end end
end
end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الدردشه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الاونلاين بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الصور بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الكلايش بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الدخول بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الفيديو بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙المتحركه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الاغاني بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الصوت بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الروابط بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙المواقع بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙المعرفات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الملفات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الهاشتاك بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '️♪︙الجهات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الشبكات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙العربيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الانكليزيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الملصقات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الماركداون بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الاشعارات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙التوجيه بالفعل مقفل في المجموعه', 1, 'md')
end
end
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الدردشه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الكلايش بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الدخول بالفعل مفتوح في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الفيديو بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الملفات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الاونلاين بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الماركداون بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙المتحركه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الاغاني بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الصوت بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الروابط بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙المواقع بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙المعرفات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الهاشتاك بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الجهات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الشبكات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙العربيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الانكليزيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الاشعارات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙الملصقات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙التوجيه بالفعل مفتوح في المجموعه', 1, 'md')
end
end
end
end
...
if not Constructor(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمنشئين فقط', 1, 'md')
else
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙اختر عدد اكبر من 40 حرف ', 1, 'md')
else
DevAbs:set(WaTaN2..'Abs:Spam:Text'..msg.chat_id_,SetSpam)
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم وضع عدد السبام ↫'..SetSpam, 1, 'md')
end
end
end
--     Source WaTaN2     --
...
if #admins == 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*لاتوجد بوتات هنا*", 1, 'md')
return false end
if #admins == i then 
local a ='┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n♪︙*عدد البوتات هنا* ↫ '..n..'\n'
local f ='♪︙*عدد البوتات المرفوعه* ↫ '..t..'\n♪︙*ملاحضه علامة الـ*✯ *تعني ان البوت ادمن في هذه المجموعه*'
DevAbs(msg.chat_id_, msg.id_, 1, text..a..f, 1, 'md')
end
end,nil)
end
end,nil)
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙*عدد البوتات هنا* ↫ "..c.."\n♪︙*عدد البوتات المرفوعه* ↫ "..x.."\n♪︙*تم طرد* ↫ "..(c - x).." *من البوتات*", 1, 'md')
end 
end,nil)  
end 
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمنشئ الاساسي فقط', 1, 'md')
else
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حذف ↫ ❨ قائمة المنع • المحظورين • المكتومين • الادمنيه • المميزين • المطايه ❩ بنجاح \n ✓", 1, 'md')
end end
--     Source WaTaN2     --
if text and text:match("^حذف جميع الرتب$") and ChCheck(msg) or text and text:match("^مسح جميع الرتب$") and ChCheck(msg) or text and text:match("^تنزيل جميع الرتب$") and ChCheck(msg) then
if not AliConstructor(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمالكين فقط', 1, 'md')
else
...
DevAbs:del(WaTaN2..'Abs:VipMem:'..msg.chat_id_)
DevAbs:del(WaTaN2..'User:Donky:'..msg.chat_id_)
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حذف جميع الرتب التاليه ↫ ❨ "..basicconstructort..constructort..Managerst..adminst..vipmemt..donkyt.." ❩ بنجاح \n ✓", 1, 'md')
else
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لاتوجد رتب هنا", 1, 'md')
end 
end 
end
--     Source WaTaN2     --
...
.."♪︙عدد السبام ↫ "..spam_c.."\n"
.."┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n♪︙[Source Channel](https://t.me/PPPTP)\n"
DevAbs(msg.chat_id_, msg.id_, 1, TXTE, 1, 'md')
end
end
--     Source WaTaN2     --
if text and text:match("^كول (.*)$") and ChCheck(msg) then
local txt = {string.match(text, "^(كول) (.*)$")}
DevAbs(msg.chat_id_,0, 1, txt[2], 1, 'md')
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevAbs:del(WaTaN2..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAbs:del(WaTaN2..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs:set(WaTaN2..'Abs:rules'..msg.chat_id_,text)
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ قوانين المجموعه', 1, 'md')
return false   
end
if text and text:match("^ضع قوانين$") and ChCheck(msg) or text and text:match("^وضع قوانين$") and ChCheck(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙ارسل لي القوانين الان', 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 1, rules, 1, nil)
end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر الزخرفه', 1, 'md')
...
if text =='زخرفه' and ChCheck(msg) or text =='الزخرفه' and ChCheck(msg) or text =='↫ الزخرفه ♪' and ChCheck(msg) then  
DevAbs:setex(WaTaN2.."Zrf:Abs"..msg.chat_id_..msg.sender_user_id_,300,true)
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙ارسل لي الكلمه لزخرفتها \nيمكنك الزخرفة باللغه { en } ~ { ar } ', 1, 'md')
end
end
if not DevAbs:get(WaTaN2..'Abs:Zrf:Abs'..msg.chat_id_) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevAbs:get(WaTaN2..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الحب ', 1, 'md')
DevAbs:del(WaTaN2..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙نسبة الحب بين '..text..' هي : '..Ali..'%', 1, 'md')
DevAbs:del(WaTaN2..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbs:get(WaTaN2..'Abs:Nsba:Abs'..msg.chat_id_) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
...
if text and text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevAbs:del(WaTaN2..'RyNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙نسبة الخيانه بين '..text..' هي : '..Ali..'%', 1, 'md')
DevAbs:del(WaTaN2..'RyNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbs:get(WaTaN2..'Abs:Nsba:Abs'..msg.chat_id_) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
...
if text and text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevAbs:del(WaTaN2..'JNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙نسبة جمال '..text..' هي : '..Ali..'%', 1, 'md')
DevAbs:del(WaTaN2..'JNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbs:get(WaTaN2..'Abs:Nsba:Abs'..msg.chat_id_) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
...
if text and text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الكره ', 1, 'md')
DevAbs:del(WaTaN2..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙نسبة الكره بين '..text..' هي : '..Ali..'%', 1, 'md')
DevAbs:del(WaTaN2..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbs:get(WaTaN2..'Abs:Nsba:Abs'..msg.chat_id_) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
...
if text and text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevAbs:del(WaTaN2..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙نسبة رجولة '..text..' هي : '..Ali..'%', 1, 'md')
DevAbs:del(WaTaN2..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbs:get(WaTaN2..'Abs:Nsba:Abs'..msg.chat_id_) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
...
if text and text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevAbs:del(WaTaN2..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙نسبة انوثة '..text..' هي : '..Ali..'%', 1, 'md')
DevAbs:del(WaTaN2..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbs:get(WaTaN2..'Abs:Nsba:Abs'..msg.chat_id_) then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
...
if text and text =='الغاء' then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevAbs:del(WaTaN2..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙نسبة غباء '..text..' هي : '..Ali..'%', 1, 'md')
DevAbs:del(WaTaN2..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
--     Source WaTaN2     --
...
--     Source WaTaN2     --
if text == "حساب العمر" or text == "↫ حساب العمر ♪" then
local WaTaNTeaM ='احسب + تاريخ ميلادك'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, WaTaNTeaM, 14, string.len(msg.sender_user_id_))
DevAbs:del(WaTaN2..'Abs:Age:Abs'..msg.chat_id_) 
end
--     Source WaTaN2     --
if text == "↫ الابراج ♪" or text == "الابراج" then
local WaTaNTeaM ='برج + نوع البرج'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, WaTaNTeaM, 14, string.len(msg.sender_user_id_))
DevAbs:del(WaTaN2..'Abs:Age:Abs'..msg.chat_id_) 
end
--     Source WaTaN2     --
if text == "↫ معاني الاسماء ♪" or text == "معاني الاسماء" then
local WaTaNTeaM ='معنى اسم + الاسم'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, WaTaNTeaM, 14, string.len(msg.sender_user_id_))
DevAbs:del(WaTaN2..'Abs:Age:Abs'..msg.chat_id_) 
end
--     Source WaTaN2     --
...
local Text ='*♪︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/gif:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
...
local Text ='*♪︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/memz:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
...
local Text ='*♪︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/Song:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/AudiosReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/mp3:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendAudio?chat_id=' .. msg.chat_id_ .. '&audio=https://t.me/ReLaXMp3/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
...
Ali = math.random(2,612); 
local Text ='*♪︙تم اختيار الريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/remix:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RemixReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
...
local Text ='*♪︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/photo:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PhotosReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
...
local Text ='*♪︙تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/anime:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AnimeReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
...
Ali = math.random(45,125); 
local Text ='*♪︙تم اختيار الفلم لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/Movies:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MoviesReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
...
Ali = math.random(2,54); 
local Text ='*♪︙تم اختيار المسلسل لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=" مره اخرى ",callback_data="/series:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SeriesReLaX/'..Ali..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source WaTaN2     --
if Admin(msg) then
if DevAbs:get(WaTaN2..'Abs:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevAbs:get(WaTaN2..'Abs:Lock:Links'..msg.chat_id_) then mute_links ='مقفله' else mute_links ='مفتوحه' end local WaTaNTeaM = "\n" .."♪︙الروابط ↫ "..mute_links.."\n" DevAbs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
...
DevAbs(msg.chat_id_,msg.id_, 1, '♪︙ارسل صورة المجموعه الان', 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 0,'♪︙*لا يوجد محظورين*', 1, 'md')
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup ='t.me/PPPTP' end
...
ConstructorAli = "["..Ali.first_name_.."](T.me/"..(Ali.username_ or "PPPTP")..")"
else 
ConstructorAli = "حساب محذوف"
end
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙المجموعه ↫ ["..dp.title_.."]("..LinkGroup..")\n♪︙الايدي ↫ ( `"..ChatId.."` )\n♪︙المنشئ ↫ "..ConstructorAli.."\n♪︙عدد المدراء ↫ ( *"..ManagerList.."* )\n♪︙عدد المنشئين ↫ ( *"..ConstructorList.."* )\n♪︙عدد الادمنيه ↫ ( *"..AdminsList.."* )\n♪︙عدد المميزين ↫ ( *"..VipList.."* )\n♪︙عدد المحظورين ↫ ( *"..BanedList.."* )\n♪︙عدد المقيدين ↫ ( *"..TkeedList.."* )\n♪︙عدد المكتومين ↫ ( *"..MutedList.."* )", 1,"md")
end,nil)
end
end
else
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لم تتم اضافتي بها لاقوم بكشفها", 1, "md")
end
end,nil)
end,nil)
end 
...
if not AliConstructor(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لمالك المجموعه او اعلى فقط ', 1, 'md')
else
...
Text = "♪︙تم تفعيل المجموعه "..dp.title_
local inline = {{{text=" ترتيب الاوامر ",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text=" رفع الادمنيه ",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text=" غادر ",callback_data="/LeaveBot:"..msg.sender_user_id_},{text=" تعطيل ",callback_data="/Stop:"..msg.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevAbs:sadd(WaTaN2.."Abs:Groups",msg.chat_id_)
...
DevAbs:set(WaTaN2..'Abs:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙المجموعه بالتاكيد معطله', 1, 'md')
else
Text = "♪︙تم تعطيل المجموعه "..dp.title_
local inline = {{{text=" غادر ",callback_data="/LeaveBot:"..msg.sender_user_id_},{text=" تفعيل ",callback_data="/On:"..msg.sender_user_id_}},{{text=" ♪ ReLaX TeAM . ",url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevAbs:srem(WaTaN2.."Abs:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
local List = DevAbs:smembers(WaTaN2.."Abs:Groups")
if #List == 0 then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لا توجد مجموعات مفعله', 1, 'md')
else
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙جاري ارسال نسخه تحتوي على ↫ '..#List..' مجموعه', 1, 'md')
...
if text =='الغاء' then   
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم اذاعة "..AliText.." بنجاح \n♪︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
DevAbs:del(WaTaN2.."Abs:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم اذاعة "..AliText.." بالتثبيت \n♪︙‏في ↫ ❨ "..#List.." ❩ مجموعه \n ✓", 1, 'md')
DevAbs:del(WaTaN2.."Abs:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙لاتستطيع حذف رد وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمدير واعلى فقط ', 1, 'md')
else
local List = DevAbs:smembers(WaTaN2..'Abs:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevAbs:set(WaTaN2..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لايوجد رد متعدد لهذه الكلمه ↫ "..text ,  1, "md")
return false
end
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙قم بارسال الرد المتعدد الذي تريد حذفه من الكلمه ↫ "..text ,  1, "md")
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل الكلمه لحذفها" ,  1, "md")
return false
end
if text =='اضف رد متعدد' and ChCheck(msg) then
if not Bot(msg) and DevAbs:get(WaTaN2..'Abs:Lock:Rd'..msg.chat_id_) then 
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙لاتستطيع اضافه رد وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمدير واعلى فقط ', 1, 'md')
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
...
SendInline(msg.chat_id_,Ali,nil,inline,msg.id_/2097152/0.5)
DevAbs:del(WaTaN2..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
return false
end
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الامر ارسل الرد الاول\n♪︙للخروج ارسل ↫ ( الغاء )" ,  1, "md")
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل امر `كت تويت` الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الامر ارسل السؤال الاول\n♪︙للخروج ارسل ↫ ( الغاء )" ,  1, "md")
...
local inline = {{{text=" تغير الرد ",callback_data="/ChangeRed:"..msg.sender_user_id_}},{{text=" الغاء ",callback_data="/CancelRed:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
return false
end end
--     Source WaTaN2     --
...
if not SecondSudo(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمطور الثانوي واعلى فقط ', 1, 'md')
return false
end
...
DevAbs:sadd(WaTaN2.."Abs:Sudo:AllRed",text)
DevAbs:set(WaTaN2.."DelSudoRep",text)
local inline = {{{text=" تغير الرد ",callback_data="/ChangeAllRed:"..msg.sender_user_id_}},{{text=" الغاء ",callback_data="/CancelAllRed:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
return false
end end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙لاتستطيع حذف ردود المتعدده وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمدير او اعلى فقط ', 1, 'md')
else
local redod = DevAbs:smembers(WaTaN2..'Abs:Manager:GpRedod'..msg.chat_id_)
if #redod == 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لا توجد ردود متعدده مضافه" ,  1, "md")
...
local inline = {{{text=" مسح ردود المدير ",callback_data="/DelGpRed:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
...
if not Bot(msg) and DevAbs:get(WaTaN2..'Abs:Lock:GpRd'..msg.chat_id_) then 
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙لاتستطيع حذف ردود المدير وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمدير او اعلى فقط ', 1, 'md')
...
local redod = DevAbs:smembers(WaTaN2..'Abs:Manager:GpRed'..msg.chat_id_)
if #redod == 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لا توجد ردود مضافه" ,  1, "md")
else
for k,v in pairs(redod) do
...
local inline = {{{text=" مسح ردود المطور ",callback_data="/DelGpRedAll:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
SendInline(msg.chat_id_,MsgRep,nil,inline,msg.id_/2097152/0.5)
end
if text and (text == "حذف ردود المطور" or text == "حذف ردود العام" or text == "مسح ردود المطور" or text == "↫ مسح ردود العام ♪") then
if not Bot(msg) and DevAbs:get(WaTaN2..'Abs:Lock:GpRd'..msg.chat_id_) then 
DevAbs(msg.chat_id_, msg.id_, 1,'♪︙لاتستطيع حذف ردود المطور وذالك بسبب تعطيله', 1, 'md')
return false
end
if not SecondSudo(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙للمطور الثانوي او اعلى فقط ', 1, 'md')
else
local redod = DevAbs:smembers(WaTaN2.."Abs:Sudo:AllRed")
if #redod == 0 then
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙لا توجد ردود مضافه" ,  1, "md")
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل لي اسم البوت الان" ,  1, "md") 
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم استعادة الكلايش الاصليه" ,  1, "md") 
end
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل كليشة (الاوامر) الان " ,  1, "md")
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل كليشة (م1) الان " ,  1, "md")
...
if not Admin(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙هذا الامر يخص الرتب الاعلى فقط\n♪︙ارسل ↫ (م6) لعرض اوامر الاعضاء', 1, 'md')
else
local Help = DevAbs:get(WaTaN2..'Abs:Help1')
local Text = [[
♪︙اوامر حماية المجموعه ↫ ⤈
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل كليشة (م3) الان " ,  1, "md")
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل كليشة (م4) الان " ,  1, "md")
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل كليشة (م5) الان " ,  1, "md")
...
if not SudoBot(msg) then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙هذا الامر للمطورين فقط', 1, 'md')
else
local Help = DevAbs:get(WaTaN2..'Abs:Help5')
local Text = [[
♪︙اوامر المطورين ↫ ⤈
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل كليشة (م6) الان " ,  1, "md")
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text=" مسح الاساسيين ",callback_data="/DelAliSudo:"..msg.sender_user_id_},{text=" مسح الثانويين ",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text=" مسح المطورين ",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text=" مسح المالكين ",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text=" مسح المنشئين الاساسيين ",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text=" مسح المنشئين ",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text=" مسح المدراء ",callback_data="/DelManagers:"..msg.sender_user_id_},{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif AliSudo(msg) then
keyboard.inline_keyboard = {{{text=" مسح الثانويين ",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text=" مسح المطورين ",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text=" مسح المالكين ",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text=" مسح المنشئين الاساسيين ",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text=" مسح المنشئين ",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text=" مسح المدراء ",callback_data="/DelManagers:"..msg.sender_user_id_},{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif SecondSudo(msg) then
...
keyboard.inline_keyboard = {{{text=" مسح المنشئين الاساسيين ",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text=" مسح المنشئين ",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text=" مسح المدراء ",callback_data="/DelManagers:"..msg.sender_user_id_},{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text=" مسح المنشئين ",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text=" مسح المدراء ",callback_data="/DelManagers:"..msg.sender_user_id_},{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text=" مسح المدراء ",callback_data="/DelManagers:"..msg.sender_user_id_},{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text=" مسح الادمنيه ",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text=" مسح المميزين ",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text=" مسح المميزين ",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text=" • اخفاء الكليشه • ",callback_data="/HideHelpList:"..msg.sender_user_id_},{text=" القائمه الرئيسيه ",callback_data="/DelList:"..msg.sender_user_id_}},{{text=' ♪ ReLaX TeAM . ',url="t.me/PPPTP"}}}
end
Msg_id = msg.id_/2097152/0.5
...
--     Source WaTaN2     --
if text == "مسح قائمه المنع" and AliConstructor(msg) then
local Filter = DevAbs:get(WaTaN2..'Abs:Filter')
local Text = [[
♪︙اهلا بك في قائمة المنع ↫ ⤈ 
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
...
if text and text:match('^بحث (.*)$') and not DevAbs:get(ReLaXX.."Abs:WhyTube"..msg.chat_id_) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('http://relaxali.ml/ReLaXX/ralax.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source WaTaN2     --
if SecondSudo(msg) then
if text == "تحديث السورس" and ChCheck(msg) or text == "تحديث سورس" and ChCheck(msg) or text == "↫ تحديث السورس ♪" and ChCheck(msg) then 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙جاري تحديث سورس ريلاكس', 1, 'md') 
os.execute('rm -rf WaTaN2.lua') 
os.execute('wget https://raw.githubusercontent.com/WaTaNTeaM/WaTaN2/main/WaTaN2.lua') 
dofile('WaTaN2.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم التحديث الى الاصدار الجديد', 1, 'md') 
end
if text =='تحديث البوت' and ChCheck(msg) or text =='↫ تحديث ♪' and ChCheck(msg) then  
dofile('WaTaN2.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n        ( تم تحديث ملفات البوت )        \n\27[0;34;49m\n") 
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم تحديث ملفات البوت", 1, "md")
end
--     Source WaTaN2     --
...
DevAbs:set(WaTaN2..'Abs:NameBot',(DevAbs:get(WaTaN2..'Name:Bot') or 'ريلاكس'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم حذف معلومات الترحيب', 1, 'md')   
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم تفعيل الترحيب عند اضافة البوت في المجموعه', 1, 'md')   
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم تعطيل الترحيب عند اضافة البوت في المجموعه', 1, 'md')   
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙ارسل لي نص الترحيب', 1, 'md') 
DevAbs:del(WaTaN2..'Abs:Text:BotWelcome')
DevAbs:del(WaTaN2..'Abs:Photo:BotWelcome')
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ النص ارسل لي صورة الترحيب\n♪︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
...
if text and text:match("^الغاء$") then 
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ النص والغاء حفظ صورة الترحيب", 1, "md") 
DevAbs:del(WaTaN2.."Abs:Set:BotWelcome"..msg.sender_user_id_)    
return false
end 
if msg.content_.photo_ and msg.content_.photo_.sizes_[1] then   
DevAbs:set(WaTaN2.."Abs:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ النص وصورة الترحيب", 1, 'md')   
DevAbs:del(WaTaN2.."Abs:Set:BotWelcome"..msg.sender_user_id_)   
end
return false
end
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙ارسل كليشة المطور الان ", 1, "md")
...
DevAbs(msg.chat_id_, msg.id_, 1, "♪︙تم حذف كليشة المطور", 1, "md")
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙تم تغيير كليشة الاشتراك الاجباري', 1, 'md')
end
...
DevAbs(msg.chat_id_, msg.id_, 1,textt, 1, 'md') 
end end
...
local chtext = DevAbs:get(WaTaN2.."Abs:ChText")
if chtext then
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙كليشة الاشتراك ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n['..chtext..']', 1, 'md')
else
if DevAbs:get(WaTaN2.."Abs:ChId") then
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevAbs:get(WaTaN2.."Abs:ChId"))
local GetInfo = JSON.decode(Check)
...
DevAbs(msg.chat_id_, msg.id_, 1, '♪︙لم يتم تعيين قناة الاشتراك الاجباري \n♪︙ارسل ↫ تعيين قناة الاشتراك للتعيين ', 1, 'md')
end end end end
--     Source WaTaN2     --
...
Text = [[
♪︙[قناة السورس](https://t.me/PPPTP)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text=' قناة السورس ',url="t.me/PPPTP"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PPPTP&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
Text = [[
♪︙[مبرمج السورس](https://t.me/AAAPA)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text=' مبرمج السورس ',url="t.me/AAAPA"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AAAPA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source WaTaN2     --
...
DevAbs(msg.chat_id_, msg.id_, 1, io.popen([[
...
if DevAbs:get(WaTaN2..'Abs:Lock:EditMsgs'..msg.chat_id_) and not Text and not AliConstructor(result) then
